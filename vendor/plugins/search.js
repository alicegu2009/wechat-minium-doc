...
function genIndex(path, content, router, depth) {
  ...
  var _slugify = window.Docsify.slugify;
  function slugify(text) {
    var match = /:id=(\S*)/g.exec(text)
    if(match) {
      return _slugify.call(this, match[1]);
    }
    return _slugify.call(this, text);
  }
  slugify.clear = function() {_slugify.clear.call(this)};
  var index = {};
  var slug;
